...
/**
 * NationalHolidaysSearch represents the model behind the search form about `app\models\NationalHolidays`.
 */
...
class NationalHolidaysSearch extends NationalHolidays
{
    ...
    {
        return [
            [['national_holiday_id', 'created_by', 'updated_by', 'is_status'], 'integer'],
            [['national_holiday_name', 'national_holiday_date', 'national_holiday_remarks', 'created_at', 'updated_at'], 'safe'],
        ];
    }
