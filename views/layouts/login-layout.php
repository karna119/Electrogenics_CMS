...
<head>
    ...
    <meta name="Keywords" content="edusec,edusec4,Electrogenics,open source development in ahmedabad, college management software,college management system,education management software,school management system,school management software">
	...
	<meta property="og:title" content="Electrogenics - Provide Enterprise Solution | Development on open source technology | College Management Software | School Management Software" />
	...
	<meta property="og:image" content="http://www.electrogenicsech.com/rudra.png">

	<link rel="shortcut icon" href="<?php echo Yii::$app->request->baseUrl; ?>/images/electrogenicsech_favicon.png" type="image/x-icon" />
...
<div class="login-footer"> <strong>Copyright &copy; <?= date('Y') ?> <a href="http://www.electrogenicsech.com">Electrogenics</a>.</strong> All rights reserved.</div>
<?php $this->endBody() ?>
</body>
</html>
<script>
